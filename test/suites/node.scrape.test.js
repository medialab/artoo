// Why this this temporary new file?
// ---------------------------------
// We'd like to run the 'scrape.test.js' within a Node.js environment and see any unexpected failures.
//
// As a first step, we copy-pasted scrape.test.js content into this file and create a Node.js compliant helpers.
// Now we can clearly see what's going on and find out how to solve issues.
...
helpers = {
    ...
    fetchHTMLResource: function(name, cb) {
        ...
        $newDom('#'+name).append(fs.readFileSync(resourceDir + name + '.html', 'utf-8'));
        artoo.setContext($newDom)
        cb('#' + name, $newDom);
    }
};
...
describe('artoo.node.scrape', function() {
